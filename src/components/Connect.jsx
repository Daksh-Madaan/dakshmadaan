  ...
  return (
    <div id='Connect' className='text-[#E8E3D8] max-w-[90%] w-200 mt-15 m-auto'>
      ...
      <form className='flex flex-col gap-5 items-center'>
        <input type='email' className='text-[#0A0E13] bg-amber-50 rounded-md outline-0 p-2 max-w-full w-100 border-3 border-[#E8B540]' placeholder='johndoe@example.com'></input>
        <textarea className='text-[#0A0E13] bg-amber-50 rounded-md outline-0 p-2 w-full border-3 border-[#E8B540]' rows={6} placeholder='Write your message here!'></textarea>
