...
const Nav = () => {
  return (
    <div className='w-full margin-auto sticky top-5 drop-shadow-[0_2px_60px_#ffffff1d]'>
      <div className='max-w-[95%] p-1 w-max ring-2 ring-[#1F2830] m-auto bg-[#0A0E13] rounded-full flex tracking-tight drop-shadow-[0_0px_65px_#ffffff2d] justify-center text-sm'>
